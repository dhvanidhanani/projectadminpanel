<?php
  ...
  while($fetch = mysqli_fetch_assoc($result))
  {
    ...
    {
        $id1 = $_GET['delete'];
        $qry2 = "UPDATE `reson` set `status`=1 where `id`='$id1'";
    ...
    {
        $search = $_POST['search'];
        $qry1 = "SELECT * from `reson` where `name` like '%$search%'";
    }
    else
    {
        $qry1 = "SELECT * from `reson` where `status`=0";
    }
                ...
                <table id="example2" class="table table-bordered table-hover">
                  <tr>
                    ...
                    <tr>
                      ...
                      <td><?php echo $fetch['followupby'] ?></td>
                      <td><?php echo $fetch['reson'] ?></td>
                        
                      
                      <td align=center><a href="viewreson.php?delete=<?php echo $fetch['id'] ?>"><i class="fa-solid fa-trash"></i></a></td>
                      <td align=center><a href="payment.php?update=<?php echo $fetch['id'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                      </tr>
                    <?php
                      }
                    ?>
